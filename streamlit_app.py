...
# Se hai caricato logo.png, apparirà nella tab del browser
...
with col_logo:
    try:
        ...
        st.write("📈") # Icona di backup se il logo non è presente
...
if not selected_countries:
    ...
    map_year_data = gdp_df[gdp_df['Year'] == to_year]
    fig_map = px.choropleth(
        map_year_data, locations="Country Code", color="GDP", 
        hover_name="Country Name", color_continuous_scale=px.colors.sequential.Goldred,
